	...
	**/
	...
	function iatExtension(options)
	{
		...
		var iatObj =
		{
			...
			instAttributePractice: '<div><img src="Empatica.jpg" alt="TEST TEXT"><p align="center" style="font-size:20px; font-family:arial">' +
				'<font color="#000000"><u>Part blockNum of nBlocks </u><br/><br/></p>' +
				'<p style="font-size:20px; text-align:left; vertical-align:bottom; margin-left:10px; font-family:arial">' +
			...
			instCategoriesPractice: '<div><img src="Empatica.jpg" alt="TEST TEXT"><p align="center" style="font-size:20px; font-family:arial">' +
				'<font color="#000000"><u>Part blockNum of nBlocks </u><br/><br/></p>' +
				'<p style="font-size:20px; text-align:left; vertical-align:bottom; margin-left:10px; font-family:arial">' +
			...
			instFirstCombined : '<div><img src="Empatica.jpg" alt="TEST TEXT"><p align="center" style="font-size:20px; font-family:arial">' +
				'<font color="#000000"><u>Part blockNum of nBlocks </u><br/><br/></p>' +
				'<p style="font-size:20px; text-align:left; vertical-align:bottom; margin-left:10px; font-family:arial">' +
			...
			instSwitchCategories : '<div><img src="Empatica.jpg" alt="TEST TEXT"><p align="center" style="font-size:20px; font-family:arial">' +
				'<font color="#000000"><u>Part blockNum of nBlocks </u><br/><br/></p>' +
				'<p style="font-size:20px; text-align:left; vertical-align:bottom; margin-left:10px; font-family:arial">' +
